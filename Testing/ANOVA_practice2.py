#! /usr/bin/env python3
# ANOVA_practice2.py
# A cleaned up version of ANOVA_practice
# See the file ANOVA_compare to test difference between ANOVA_practice and ANOVA_practice2 to make sure ANOVA_practice2 is calculating valid values and no exceptions are being thrown.
